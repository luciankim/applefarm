...
public class WebConfig implements WebMvcConfigurer{
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(loginInterceptor)
				...
				.excludePathPatterns("/product/quality/*","/product/category","/product/chart","/product/detail/*","/product/img/*", "/product/bid/*","/product/inquiry/*","/product/review/*","/product/seller/*","/product/productList/*","/product/mainList");
