...
CREATE TABLE MEMBER_TBL (
	...
	SELLER_GRADE	            LEVEL		        NOT NULL,           --(1~3) 레벨에따른 수수료 부가
...
CREATE TABLE ADDRESS_TBL (
	...
	ADDRESS_DEFALUT	        NUMBER		        NULL        -- 1:기본배송지
);
...
CREATE TABLE PRODUCT_TBL (
	...
	MEMBER_NO	                NUMBER		            NOT NULL        REFERENCES MEMBER_TBL,
	PRODUCT_QUALITY	            CHAR(1)		            NOT NULL        CHECK(PRODUCT_QUALITY IN('A','B','C','D')),
	PRODUCT_TITLE	            VARCHAR2(100)		    NOT NULL,
	PRODUCT_EXPLAIN	            VARCHAR2(10000)		    NULL,
...
CREATE TABLE BOARD_TBL (
	...
	BOARD_CONTENT	        VARCHAR2(30000)		NOT NULL,
	MEMBER_NO	            NUMBER		        NOT NULL    REFERENCES MEMBER_TBL,
...
CREATE TABLE REPORT_SELECT_TBL (
	...
	REPROT_SELECT_NO	NUMBER		    NOT NULL
);
...
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(1,'욕설을 사용했어요');
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(2,'사기를 저질렀어요');
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(3,'피싱을 시도했어요');
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(4,'위조상품을 판매했어요');
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(5,'불법활동이 의심되어요');
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(6,'불건전한 내용이 작성되었어요');
INSERT INTO REPORT_CHECK_COMPARE_TBL VALUES(7,'비방적인 언어를 사용했어요');
