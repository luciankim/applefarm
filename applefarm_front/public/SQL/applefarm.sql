...
CREATE TABLE IPHONE_TBL (
	...
	IPHONE_IMAGE	        VARCHAR2(500)		    NOT NULL,
	IPHONE_STORAGE	        VARCHAR2(100)		    NOT NULL
);

ALTER TABLE IPHONE_TBL RENAME COLUMN IPHONE_GEN TO PRODUCT_GEN;
ALTER TABLE IPHONE_TBL RENAME COLUMN IPHONE_MODEL TO PRODUCT_MODEL;
ALTER TABLE IPHONE_TBL RENAME COLUMN IPHONE_COLOR TO PRODUCT_COLOR;
ALTER TABLE IPHONE_TBL RENAME COLUMN IPHONE_IMAGE TO PRODUCT_IMAGE;
ALTER TABLE IPHONE_TBL RENAME COLUMN IPHONE_STORAGE TO PRODUCT_STORAGE;
COMMIT;
--�ƺ�
CREATE TABLE MACBOOK_TBL (
	...
	MACBOOK_IMAGE	        VARCHAR2(500)		    NOT NULL,
	MACBOOK_STORAGE	        VARCHAR2(100)		    NOT NULL,
	MACBOOK_MEMORY	        VARCHAR2(100)		    NOT NULL,
	MACBOOK_CHIP	        VARCHAR2(500)		    NULL,
    MACBOOK_CPU 	        VARCHAR2(500)		    NULL,
    MACBOOK_GPU 	        VARCHAR2(500)		    NULL
);
--�����е�
CREATE TABLE IPAD_TBL (
	...
	IPAD_IMAGE	            VARCHAR2(500)		    NOT NULL,
...
CREATE TABLE WATCH_TBL (
	...
	WATCH_IMAGE	            VARCHAR2(500)		NOT NULL,
	WATCH_SIZE	            VARCHAR2(100)		NOT NULL,
...
CREATE TABLE AIRPODS_TBL (
	...
	AIRPODS_IMAGE	        VARCHAR2(500)		NOT NULL,
