...
/*
1.  ProductTab 컴포넌트를 사용할 상위 컴포넌트에서 다음의 useState를 생성한다
...
2.  ProductTab 컴포넌트를 사용할 상위 컴포넌트에서 다음의 함수를 선언한다.
      - const changeTab = (e) => {
...
3.  ProductTab 컴포넌트를 사용할 상위 컴포넌트에서 ProductTab컴포넌트 안에 다음의 속성을 입력한다.
      - <ProductTab
          productTab={productMainTab}
          changeTab={changeMainTab}
          tabNameArr=[탭 안에 표시할 문자들]//탭 안에 표시할 문자들의 배열(순서대로)
        />
...
4.  ProductTab 컴포넌트의 width는 그 컴포넌트를 감싼 상위태그의 width의 100%임.
*/
